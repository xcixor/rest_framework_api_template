...
class DroneCategoryTests(APITestCase):
    ...
    def post_drone_category(self, name):
        url = reverse('v1:{}'.format(views.DroneCategoryList.name))
        data = {'name': name}
    ...
    def test_filter_drone_category_by_name(self):
        ...
        url = '{0}?{1}'.format(
            reverse('v1:{}'.format(views.DroneCategoryList.name)),
    ...
    def test_update_drone_category(self):
        ...
        url = reverse(
            'v1:{}'.format(views.DroneCategoryDetail.name),
            None,
            {response.data['pk']})
...
class PilotTests(APITestCase):
    def post_pilot(self, name, gender, races_count):
        url = reverse('v1:{}'.format(views.PilotList.name))
        data = {
            'name': name,
            'gender': gender,
